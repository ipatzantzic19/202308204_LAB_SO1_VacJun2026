...
LOCUST_IMAGE="$REGISTRY/sopes1/locust:v2"
RABBITMQ_SOURCE_IMAGE="rabbitmq:3.13-management"
RABBITMQ_IMAGE="$REGISTRY/library/rabbitmq:3.13-management"
GO_CONSUMER_IMAGE="$REGISTRY/sopes1/go-consumer:v2"
GO_METRICS_EXPORTER_IMAGE="$REGISTRY/sopes1/go-metrics-exporter:v5"
OCI_ARTIFACT="$REGISTRY/sopes1/prediction-proto:v1"
VALKEY_SOURCE_IMAGE="valkey/valkey:8-alpine"
VALKEY_IMAGE="$REGISTRY/library/valkey:8-alpine"
UBUNTU_DISK_SOURCE_IMAGE="quay.io/containerdisks/ubuntu:24.04"
UBUNTU_DISK_IMAGE="$REGISTRY/library/ubuntu-container-disk:24.04"
